...
export const getJson = ({ formData, setFormData, options, setOptions }) => {
  const formJson = {
    formConfig: {
      size: 'small',
    ...
    formItemConfig: {
      guojia: {
        ...
        wrapperCol: { span: 24 },
        component: {
          options: options.guojiaOptions,
          allowClear: true,
          value: formData.auditStatus,
          setValue: (val: any) => setFormData({ ...formData, guojia: val }),
          onChange: (val: any) => {
            setOptions((prev: any) => ({
              ...prev,
              shengOptions: options.shengOptions.filter((item: { parentValue: string }) => item.parentValue === val)
            }))
          }
        },
        name: 'guojia',
      ...
      sheng: {
        ...
        wrapperCol: { span: 24 },
        component: {
          options: options.shengOptions,
          allowClear: true,
          value: formData.sheng,
          setValue: (val: any) => setFormData({ ...formData, sheng: val }),
          onChange: (val: any) => {
            setOptions((prev: any) => ({
              ...prev,
              shiOptions: options.shiOptions.filter((item: { parentValue: string }) => item.parentValue === val)
            }))
          }
        },
        name: 'sheng',
      ...
      shi: {
        ...
        wrapperCol: { span: 24 },
        component: {
          options: options.shiOptions,
          allowClear: true,
          value: formData.auditStatus,
          setValue: (val: any) => setFormData({ ...formData, shi: val }),
          onChange: (val: any) => {
            setOptions((prev: any) => ({
              ...prev,
              quOptions: options.quOptions.filter((item: { parentValue: string }) => item.parentValue === val)
            }))
          }
        },
        name: 'shi',
